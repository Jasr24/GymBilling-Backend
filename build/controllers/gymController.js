...
class GymController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            console.log(table);
            if (table == "clientes") {
                data = yield database_1.default.query(`SELECT clientes.id, tipos_documentos.nombre AS documento_id, clientes.identificacion, clientes.nombres, clientes.apellidos, clientes.telefono, clientes.email, clientes.nota, clientes.estado from ${table} INNER JOIN tipos_documentos ON clientes.documento_id = tipos_documentos.id`);
            }
            else {
